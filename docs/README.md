...
| [reader-listen-sentence-unit-impl.md](./reader-listen-sentence-unit-impl.md)               | **实现思路**：听书按句合成与迷你条上下句切换                                          |
| [reader-listen-tts-prefetch-impl.md](./reader-listen-tts-prefetch-impl.md)                 | **实现思路**：TTS 预取错开 timed、合成失败透出不抛穿                                  |
